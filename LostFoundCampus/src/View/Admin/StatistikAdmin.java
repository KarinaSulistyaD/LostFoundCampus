...
public class StatistikAdmin extends AppFrame {
    ...
    public StatistikAdmin(JFrame parentFrame) {
        ...
        topBar.add(AppLabelFactory.sectionTitle("Statistik Barang"), BorderLayout.WEST);
        ...
        // Stat cards
        content.add(makeStatCard("Total Barang", String.valueOf(totalBarang), AppTheme.PRIMARY,  28,  60, 210, 120));
        content.add(makeStatCard("Barang Hilang", String.valueOf(totalHilang), AppTheme.DANGER,  258,  60, 210, 120));
        content.add(makeStatCard("Barang Ditemukan", String.valueOf(totalDitemukan), AppTheme.SUCCESS, 488,  60, 210, 120));

        // Info panel
        JPanel infoPanel = makeInfoPanel(totalBarang, totalHilang, totalDitemukan);
        infoPanel.setBounds(28, 210, 670, 160);
    ...
    private JPanel makeInfoPanel(int total, int hilang, int ditemukan) {
        ...
        String[] info = {
            "• Total keseluruhan barang terdaftar  : " + total + " barang",
            "• Barang berstatus Hilang             : " + hilang + " barang (" + pctHilang + "%)",
            "• Barang berstatus Ditemukan          : " + ditemukan + " barang (" + pctDitemukan + "%)",
        };
        int ty = 50;
