    ...
    private void claimSelectedBarang() {
        ...
        if (row == -1) { 
            JOptionPane.showMessageDialog(this, 
                    "Pilih barang yang ingin diklaim terlebih dahulu"); 
            return; 
        }
        ...
        if (uid == 0) { 
            JOptionPane.showMessageDialog(this, 
                    "Silakan login kembali untuk mengajukan claim"); 
            return; 
        }
        ...
        if (barang.getUserId() == uid) { 
            JOptionPane.showMessageDialog(this, 
                    "Barang milik Anda sendiri tidak perlu diajukan claim"); 
            return; 
        }
        ...
        // Open styled popup dialog
        new ModalClaimBarang(this, barangId, uid);
        loadTable();
    }
}
